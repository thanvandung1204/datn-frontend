        ...
        <div className='address my-10'>
          ...
          <div className='py-5'>
            <div className='info flex flex-col'>
              ...
              <span className='text-[12px] text-[#0000008a]'>Địa chỉ: My Dinh Ha Noi</span>

              <span className='text-[12px] text-[#0000008a]'>Ghi chú: 1</span>
              <span className='text-[12px] text-[#0000008a]'>Thời gian đặt hàng: 123</span>
            </div>
          </div>
          <div className='bg_image'></div>
        </div>
        <div className='content'>
            ...
            <div className='item flex items-center gap-x-3 mb-10 shadow-md p-2 rounded'>
              <div className='left flex gap-x-3 flex-1'>
                <div className='min-w-max'>
                  <img src={'../../../public/icon-glass-tea.png'} alt='' className='w-full h-full object-cover' />
                </div>
                <div>
                  ...
                  <div className='flex flex-col gap-y-1'>
                    ...
                    <span className='text-sm text-[#866312]'>Toppings: </span>
              ...
              <div className='right'>
                <div className='price flex flex-col items-end'>
                  <span className='text-[#866312] ml-2'></span>
                </div>
              </div>
            </div>
          ...
          <div className='payment-info'>
            <div className='flex justify-end  items-center py-3 text-right border-b border-b-[#ccc]'>
              ...
              <div className='w-[200px] text-[#866312] border-l border-l-[#ccc]'></div>
            </div>
            <div className='flex justify-end  items-center py-3 text-right border-b border-b-[#ccc]'>
            ...
            <div className='flex justify-end  items-center py-3 text-right border-b border-b-[#ccc]'>
              ...
              <div className='w-[200px] text-2xl text-[#866312] border-l border-l-[#ccc]'></div>
            </div>
          </div>
          <div className='payment-method flex justify-end  items-center py-3 text-right'>
            ...
            <div className='w-[200px] border-l border-l-[#ccc] text-sm text-[#EE4D2D]'>Thanh toán khi nhận hàng</div>
          </div>
        </div>
      </div>
    </>
